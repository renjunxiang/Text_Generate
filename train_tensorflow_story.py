...
def train(maxlen=40,
          ...
          len_max=10e8,
          cut=False,
          process_path=DIR + '/model/story/data_process.pkl'
          ):
    '''
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(epochs):
            ...
            if epoch % 1 == 0:
                saver.save(sess, DIR + '/model/%s/train' % file, global_step=epoch)


if __name__ == '__main__':
    train(mode='length', file='story', cut=True,
          maxlen=300, num_words=20000,
